      ...
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/70 dark:border-white/10 dark:bg-slate-900 dark:shadow-none sm:p-8">
        ...
        <div className="mb-7 flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-sm font-medium text-slate-500 dark:text-slate-400">
            Join DocTime and book care faster
          </p>
        </div>
        ...
        <Form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <TextField isRequired name="name" type="text" className="flex flex-col gap-1.5">
            <Label className="text-sm font-bold text-slate-700 dark:text-slate-200">Full Name</Label>
            <Input 
          ...
          <Button 
            type="submit" 
            isLoading={isLoading}
            className="mt-2 w-full rounded-xl bg-teal-600 py-3 font-black text-white shadow-sm transition hover:bg-teal-700"
          >
