    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
            <Card className="border border-slate-100 bg-white mx-auto w-full max-w-md p-8 rounded-3xl shadow-sm">
                ...
                {/* Social Login */}
                <Button variant="secondary" className="w-full border border-slate-200 bg-white text-slate-700 font-semibold py-3 rounded-xl hover:bg-slate-50 transition flex items-center justify-center gap-2 shadow-sm">
                    {/* Google Icon SVG */}
