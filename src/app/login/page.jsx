        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
            <Card className="border border-slate-100 bg-white mx-auto w-full max-w-md p-8 rounded-3xl shadow-sm">
                ...
                <div className="flex flex-col items-center mb-6">
                    ...
                    <h1 className="text-center text-2xl font-bold text-slate-800">Login</h1>
                    <p className="text-sm text-slate-500 mt-1">Welcome back to DocAppoint</p>
                </div>
                ...
                <Form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-end -mt-1">
                        <a href="/forgot-password" className="text-xs font-medium text-slate-500 hover:text-[#00a896] hover:underline transition">
                            Forgot Password?
                        </a>
                    </div>
                ...
                <p className="text-center text-sm text-slate-500 mt-6">
                    ...
                    <a href="/register" className="text-[#00a896] font-semibold hover:underline">
                        Register
                    </a>
                </p>
            </Card>
