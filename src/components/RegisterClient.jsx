...
import { FaStethoscope, FaEye, FaEyeSlash } from "react-icons/fa6"; 
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-28 dark:bg-slate-950">
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/70 dark:border-white/10 dark:bg-slate-900 dark:shadow-none sm:p-8">
        <div className="mb-7 flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-sm font-medium text-slate-500 dark:text-slate-400">Join DocTime and book care faster</p>
        </div>
        ...
        <Form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <TextField name="photoUrl" type="url" className="flex flex-col gap-1.5">
            <Label className="text-sm font-bold text-slate-700 dark:text-slate-200">Photo URL</Label>
            <Input 
          ...
          <TextField isRequired name="password" type={showPassword ? "text" : "password"} className="flex flex-col gap-1.5">
            <Label className="text-sm font-bold text-slate-700 dark:text-slate-200">Password</Label>
            <div className="relative w-full">
              <Input 
                placeholder="Enter your password"
                className="w-full rounded-xl border border-slate-200 bg-white pl-3 pr-10 py-2.5 text-slate-800 outline-none transition focus:border-teal-500 dark:border-white/10 dark:bg-white/5 dark:text-white" 
              />
              <button
                type="button"
        ...
        <p className="mt-6 text-center text-sm font-medium text-slate-500 dark:text-slate-400">
          ...
          <Link href="/login" className="font-black text-teal-700 hover:underline dark:text-teal-300">
            Login
          </Link>
        </p>
      </div>
